...
function App() {
  return (
    ...
    <div id = "wrapper-full" className = "h-100% border">
      ...
      <div className = "h-full w-9/10 flex flex-row border m-auto p-3">

          <div id = "numblock" className = "w-2/3 h-full m-auto flex flex-grid content-fit">
            <ButtonBlock content = {numbers} color = "btn-warning"></ButtonBlock>
          </div>

          <div id = "symblock" className = "h-full w-1/4 m-auto flex flex-grid">
